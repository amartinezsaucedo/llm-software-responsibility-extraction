...
def sequentialize_responsibilities(requirements_file: str, requirements: list[Requirement], chat: bool,
                                   add_responsibilities_if_missing: bool, evaluate: bool):
    director = LLMDirector(LlamaRSBuilder())
    llm = director.construct_llama_llm_responsibility_sequencing(requirements_file, chat, evaluate)
